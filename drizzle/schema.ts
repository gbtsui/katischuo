import { pgTable, uuid, text, timestamp, unique, boolean, foreignKey, index } from "drizzle-orm/pg-core"
...
export const accountsTable = pgTable("accounts_table", {
	...
	foreignKey({
			...
			name: "accounts_table_user_id_users_table_id_fk"
		}).onDelete("cascade"),
]);
...
export const sessionsTable = pgTable("sessions_table", {
	...
	unique("sessions_table_token_unique").on(table.token),
]);
